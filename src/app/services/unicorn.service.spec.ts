...
describe('UnicornService', () => {
  ...
  it('should create a baby with skills that are averaging of each parent', () => {
    ...
    const agilityAverage = Math.round((unicorn1.agility + unicorn2.agility)/2);
    expect(baby.agility).toEqual(agilityAverage);

    const intelligenceAverage = Math.round((unicorn1.intelligence + unicorn2.intelligence)/2);
    ...
    const kindnessAverage = Math.round((unicorn1.kindness + unicorn2.kindness)/2);
    expect(baby.kindness).toEqual(kindnessAverage);

    const strengthAverage = Math.round((unicorn1.strength + unicorn2.strength)/2);
